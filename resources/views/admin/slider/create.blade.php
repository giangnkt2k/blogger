    ...
    <div class="card card-default">
        ...
        <div class="card-body">
            <form action="{{ route('store.slider')}}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    <label for="exampleFormControlTextarea1">Slider Link</label>
                    <textarea class="form-control" name="link" id="exampleFormControlTextarea1" placeholder="Enter Link"></textarea>
                </div>
