...
<head>
  ...
  <body class="bg-light-gray" id="body">
            ...
            <div class="card-header bg-primary">
              <div class="app-brand">
                <a href="/index.html">
                  ...
                  <span class="brand-name">Giang Dashboard</span>
                </a>
              </div>
            </div>
      ...
      <div class="copyright pl-0">
        <p class="text-center">&copy; 2020 Copyright GiangNKT
          <a class="text-primary" href="http://www.iamabdus.com/" target="_blank">NKT</a>.
        </p>
      </div>
    </div>
</body>
